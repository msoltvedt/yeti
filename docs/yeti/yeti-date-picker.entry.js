...
const YetiDatePicker = class {
    ...
    render() {
        ...
        return (h("div", { key: '6c594639b2e601a55d061893ebf05e3694683a22', class: "yeti-date" }, (this.showErrorTooltip && this.isValid == false) ?
            h("yeti-tooltip", { text: this.tooltipText, position: "below", forceOpen: true }, this.renderInput(cssClasses))
            :
                this.renderInput(cssClasses), h("button", { key: 'f181eb9f0996f7881e5266a48bf432db1c0d5438', class: "yeti-date-button", "aria-label": this.getIconButtonLabel(), onClick: (ev) => { this.handleIconClick(ev); } }, h("span", { key: '9042fcde02f1770fd3a4479beaac9c5ba3c6845d', class: "material-icons yeti-date-button-icon", "aria-hidden": "true" }, "calendar_today")), h("div", { key: '3a37226bfe474b76e743b2b25668b38831f06250', class: (this.isPickerVisible) ? "yeti-date-picker yeti-date-picker__visible" : "yeti-date-picker" }, h("div", { key: 'd2d88d7b823143c3c6e9508ecda64272aef05c5c', class: "yeti-date-picker-header" }, h("h2", { key: 'f64528e33760b8bd566e3e3c723745993097cc26', class: "yeti-date-picker-heading", "aria-live": "polite", id: this.pickerHeading }, utils.getMonthName(this.cursorDate), " ", this.cursorDate.getFullYear()), h("ul", { key: '2639625639049948eef7ca96ab30991971fbb5fb', class: "yeti-date-picker-actions" }, h("li", { key: '38892d55f92307a4ff842f7b93af2f3efe3c4562', class: "yeti-date-picker-action" }, h("button", { key: '81b7043ce92e3251ac78e5e6a232a1d5e66ab0b3', class: "yeti-date-picker-action-button yeti-date-picker-action-button-first", onClick: (ev) => {
                this.cursorDatePreviousYear();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: 'd5505e0fb135095f7abb1d525b5f10225feb2aaf', class: "yeti-a11y-hidden" }, "Previous year"), h("span", { key: 'aaa857361aac02f49512a017a2c79b96cc4b0cec', class: "material-icons", "aria-hidden": "true", title: "Previous year" }, "keyboard_double_arrow_left"))), h("li", { key: '0d1a8d7d4530f46b81ac9c442b4ac2dbdafadff9', class: "yeti-date-picker-action" }, h("button", { key: 'a16f7ea1c962e1bf11cd54108083d5b6b8a12c4c', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDatePreviousMonth();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: '49292156b3e8d99102cef4a31df91667c1ff2f30', class: "yeti-a11y-hidden" }, "Previous month"), h("span", { key: '0b02a721df55ab0e5924e8c17a6b02ed3ea6453f', class: "material-icons", "aria-hidden": "true", title: "Previous month" }, "keyboard_arrow_left"))), h("li", { key: '4c78a0883034479d43bc26d75752031d2165c669', class: "yeti-date-picker-action" }, h("button", { key: 'f52e39890d9e22b7649d8a2b6c52115595f9ae1d', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDateNextMonth();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: '11e8b84890716aad3c6b33f5c02b15e25c4ed57a', class: "yeti-a11y-hidden" }, "Next month"), h("span", { key: '1f764788c130b72b5c0787526aa704c6afbd2499', class: "material-icons", "aria-hidden": "true", title: "Next month" }, "keyboard_arrow_right"))), h("li", { key: '438e95c8a4bd3ace53a5b52e4a958ae909559366', class: "yeti-date-picker-action" }, h("button", { key: 'd9b9273012055b9ae3123935fcea5e4419648db2', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDateNextYear();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: '008cc081e475ca90c460d4327bed41bf99aed7d2', class: "yeti-a11y-hidden" }, "Next year"), h("span", { key: 'e5b56ac19a1dcfda88b8ef917da79bccebe21218', class: "material-icons", "aria-hidden": "true", title: "Next year" }, "keyboard_double_arrow_right"))))), h("table", { key: '29eedf246e94c3e40369001310cb4bd3789d5ee5', class: "yeti-date-calendar", role: "grid", "aria-labeledby": this.pickerHeading, onKeyDown: (ev) => { this.handleCalendarKeydown(ev); } }, h("thead", { key: '5fab3f8c1915f9da9c10695717cc7eca07deabae' }, h("tr", { key: 'c8b29e91bd8f906be2e2dfa1e64eea5ee0a1357b' }, h("th", { key: 'ee161ef7f383c47c6488b2d82e27f9d4bb1278b5', class: "yeti-date-calendar-heading", abbr: "Sunday" }, "Su"), h("th", { key: 'ddf1c9bbb42bd9bc754d4760bcd45ac4961e6e13', class: "yeti-date-calendar-heading", abbr: "Monday" }, "Mo"), h("th", { key: '61bec0d453dc8c4cb8598f177da4a33a95da2de9', class: "yeti-date-calendar-heading", abbr: "Tuesday" }, "Tu"), h("th", { key: '4d518df65e497145351f9fb2a046280bc9f370b7', class: "yeti-date-calendar-heading", abbr: "Wednesday" }, "We"), h("th", { key: 'a368490b1ddff52dfdc52f8231e9f78a945404b9', class: "yeti-date-calendar-heading", abbr: "Thursday" }, "Th"), h("th", { key: '079999a9f563559d44e40a237aaf4253edd4798c', class: "yeti-date-calendar-heading", abbr: "Friday" }, "Fr"), h("th", { key: 'ed4a06beb316741a55eff3a9a73cc68817655b3c', class: "yeti-date-calendar-heading", abbr: "Saturday" }, "Sa"))), this.renderMonthTBody(this.cursorDate)))));
    }
    componentDidRender() {
