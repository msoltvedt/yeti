...
const YetiDatePicker = class {
    ...
    render() {
        ...
        return (h("div", { key: '96c18dd5b660797d8c6caeb6676fc4b1b039dd95', class: "yeti-date" }, (this.showErrorTooltip && this.isValid == false) ?
            h("yeti-tooltip", { text: this.tooltipText, position: "below", forceOpen: true }, this.renderInput(cssClasses))
            :
                this.renderInput(cssClasses), h("button", { key: '1f3fbcc97685a7a1566a48fa56033011c313d1d5', class: "yeti-date-button", "aria-label": this.getIconButtonLabel(), onClick: (ev) => { this.handleIconClick(ev); } }, h("span", { key: 'f6c877e8ae5b99972dbf57c0c6082594b31ca51e', class: "material-icons yeti-date-button-icon", "aria-hidden": "true" }, "calendar_today")), h("div", { key: '794c236b50b18e37578e2a5ff08ec6dfa03c9a2a', class: (this.isPickerVisible) ? "yeti-date-picker yeti-date-picker__visible" : "yeti-date-picker" }, h("div", { key: '15237a6892c6362c6cb3ee69023cadbb4cd4e079', class: "yeti-date-picker-header" }, h("h2", { key: '8b36884473d46d3a9924a5f023a1b47743b6db74', class: "yeti-date-picker-heading", "aria-live": "polite", id: this.pickerHeading }, utils.getMonthName(this.cursorDate), " ", this.cursorDate.getFullYear()), h("ul", { key: '8c7e18e2440cc5523ed5e68a607ae25c217819b3', class: "yeti-date-picker-actions" }, h("li", { key: '8fea2e73fbd7bffd52974b9d45dc2238fcbeb989', class: "yeti-date-picker-action" }, h("button", { key: '07738bc5a406a9053b1fa6855d1ad897278531a4', class: "yeti-date-picker-action-button yeti-date-picker-action-button-first", onClick: (ev) => {
                this.cursorDatePreviousYear();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: 'f17979148f283f2469325c5a0e32f3e78327a68c', class: "yeti-a11y-hidden" }, "Previous year"), h("span", { key: '6ffce6663227ac4bbe9b643194a5c4a41e2ac2b3', class: "material-icons", "aria-hidden": "true", title: "Previous year" }, "keyboard_double_arrow_left"))), h("li", { key: 'c576029eae6c5ee5c17bd7f810368c9b078cc9da', class: "yeti-date-picker-action" }, h("button", { key: '7fa9578c2c78872593615368414c2775d8eab9c1', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDatePreviousMonth();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: '2aa98eb387dbf875be423115b93ffd59d7aab8c2', class: "yeti-a11y-hidden" }, "Previous month"), h("span", { key: 'f7d4f53331a105f43081347e3878600e7bf2da31', class: "material-icons", "aria-hidden": "true", title: "Previous month" }, "keyboard_arrow_left"))), h("li", { key: '1b877666196f17982cd58bed51723f9b46af022f', class: "yeti-date-picker-action" }, h("button", { key: '1741889ae1386a0d01ba4cf5b157beb11a1a5892', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDateNextMonth();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: '2864c0f5a50e7a44432750638b5eb42a6588ed65', class: "yeti-a11y-hidden" }, "Next month"), h("span", { key: '1b7ea3659a6fcaaf2502642930da5b5efeb7dd51', class: "material-icons", "aria-hidden": "true", title: "Next month" }, "keyboard_arrow_right"))), h("li", { key: '0e93c911877d0a8579fa55676ad19c964fe227d3', class: "yeti-date-picker-action" }, h("button", { key: 'a3313f1b2da9aa786b0174f3c31eda4dd5915404', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDateNextYear();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: '36795dfc34379851c615943dc2001d025dc05e2c', class: "yeti-a11y-hidden" }, "Next year"), h("span", { key: '37e8d06ebbf37bcdcb3e9cffc7c1897c51179389', class: "material-icons", "aria-hidden": "true", title: "Next year" }, "keyboard_double_arrow_right"))))), h("table", { key: 'dfcc9ae8f7b519fd111c3074555791c7ccaf3f24', class: "yeti-date-calendar", role: "grid", "aria-labeledby": this.pickerHeading, onKeyDown: (ev) => { this.handleCalendarKeydown(ev); } }, h("thead", { key: '0b46c657123d0463ee954532070556ca71414f3a' }, h("tr", { key: '24e7680c8e6a54c2284e3e1c595bf6bfc6fc802d' }, h("th", { key: 'f9cb7dc335e2398b16ace36c0b865bb4bc3ce70f', class: "yeti-date-calendar-heading", abbr: "Sunday" }, "Su"), h("th", { key: '55f04a03d286a3c9d42e635388eeb09ae2535bed', class: "yeti-date-calendar-heading", abbr: "Monday" }, "Mo"), h("th", { key: '18737893ed42d314196f48a5be1f5989e8d6ec11', class: "yeti-date-calendar-heading", abbr: "Tuesday" }, "Tu"), h("th", { key: '90ae813c6247dd93df93fcccce6d1d9d7e78bae0', class: "yeti-date-calendar-heading", abbr: "Wednesday" }, "We"), h("th", { key: 'd3055eba67be105427ad98ba1795e8fd8b44da38', class: "yeti-date-calendar-heading", abbr: "Thursday" }, "Th"), h("th", { key: '66400823658a6c84e2e724c967a0a1947ddded47', class: "yeti-date-calendar-heading", abbr: "Friday" }, "Fr"), h("th", { key: '41487e9a94d9bc3ad3de13756c20c3d9574fc4e2', class: "yeti-date-calendar-heading", abbr: "Saturday" }, "Sa"))), this.renderMonthTBody(this.cursorDate)))));
    }
    componentDidRender() {
