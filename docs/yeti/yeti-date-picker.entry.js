...
const YetiDatePicker = class {
    ...
    render() {
        ...
        return (h("div", { key: '529592f37f629adc6cac860b315f6771d193b754', class: "yeti-date" }, (this.showErrorTooltip && this.isValid == false) ?
            h("yeti-tooltip", { text: this.tooltipText, position: "below", forceOpen: true }, this.renderInput(cssClasses))
            :
                this.renderInput(cssClasses), h("button", { key: '8a93407378df91aa48e2f86b66246fa76da4aa74', class: "yeti-date-button", "aria-label": this.getIconButtonLabel(), onClick: (ev) => { this.handleIconClick(ev); } }, h("span", { key: '3c915af16114cd17ea9ea39f988ad93b32b6a142', class: "material-icons yeti-date-button-icon", "aria-hidden": "true" }, "calendar_today")), h("div", { key: '295db9a831d3041d654365d1da22346f71b4c08b', class: (this.isPickerVisible) ? "yeti-date-picker yeti-date-picker__visible" : "yeti-date-picker" }, h("div", { key: '7532fcede78a230e1c1c24b173850b6dfdcf8ddb', class: "yeti-date-picker-header" }, h("h2", { key: '5d2ff4ce6797355e70ca5a7d979f1656ca985d2d', class: "yeti-date-picker-heading", "aria-live": "polite", id: this.pickerHeading }, utils.getMonthName(this.cursorDate), " ", this.cursorDate.getFullYear()), h("ul", { key: '47c25735c2e7d8bbc81f562e2a89d947543e1699', class: "yeti-date-picker-actions" }, h("li", { key: 'b3e235a978e2f6d03979d0d9cb749262885e64a7', class: "yeti-date-picker-action" }, h("button", { key: 'dec84c598ca60d46c7b5e2a50e2cb802e11b1fbd', class: "yeti-date-picker-action-button yeti-date-picker-action-button-first", onClick: (ev) => {
                this.cursorDatePreviousYear();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: 'ed4bf554b0cfabdbe8e06b49aba35a4f9471375f', class: "yeti-a11y-hidden" }, "Previous year"), h("span", { key: '8da38996775afaa50c20e0079a38f74f8a610373', class: "material-icons", "aria-hidden": "true", title: "Previous year" }, "keyboard_double_arrow_left"))), h("li", { key: '2b66149d3d420fa917bb554951d304b261ad71ca', class: "yeti-date-picker-action" }, h("button", { key: '8b39c8778aad55efb18be6ac462393f387492290', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDatePreviousMonth();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: '1aa85865341762e31cc673b91a69b5b0399f90e3', class: "yeti-a11y-hidden" }, "Previous month"), h("span", { key: '0b28c44427ad98a94190fbe30a9952f0f5b8b302', class: "material-icons", "aria-hidden": "true", title: "Previous month" }, "keyboard_arrow_left"))), h("li", { key: 'a260c5460ecbb5438c997dd2b6fd20a564393a6c', class: "yeti-date-picker-action" }, h("button", { key: '0560d5ee9c920c7b4abc7ea27b24fcb62782387a', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDateNextMonth();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: '6e7f45340fb12f7e695dff91d823f48dd69c33fb', class: "yeti-a11y-hidden" }, "Next month"), h("span", { key: 'a5ab05ca5c13589f936685dfb1781f99b34a9543', class: "material-icons", "aria-hidden": "true", title: "Next month" }, "keyboard_arrow_right"))), h("li", { key: '48bbc21468951c70450ef2e666b44913992ef1b8', class: "yeti-date-picker-action" }, h("button", { key: '12205d4a0ebdfe3a8d3f0155bfc0fd589f1a9226', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDateNextYear();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: '402191e84cee48accea7a23ecf928b5f353ba6be', class: "yeti-a11y-hidden" }, "Next year"), h("span", { key: 'b156d29ddb8f845e1a64bf753975279a0cdd3924', class: "material-icons", "aria-hidden": "true", title: "Next year" }, "keyboard_double_arrow_right"))))), h("table", { key: '8025e960fc7b4dc4d3cc942cef9be310db915c2c', class: "yeti-date-calendar", role: "grid", "aria-labeledby": this.pickerHeading, onKeyDown: (ev) => { this.handleCalendarKeydown(ev); } }, h("thead", { key: 'a026a8ac3ce87a7f348799721218da99f7e9a493' }, h("tr", { key: '2864ee09b418694ec242eda5f6fa18c7e437e4b0' }, h("th", { key: '652705c50f69772cd5cdf4c4640d81dbff8ba15c', class: "yeti-date-calendar-heading", abbr: "Sunday" }, "Su"), h("th", { key: '1fc19e27f8b78dc6abbe5a1e68880b865afcdebc', class: "yeti-date-calendar-heading", abbr: "Monday" }, "Mo"), h("th", { key: '27f154211046e390654cd3e8d15147dc064607a9', class: "yeti-date-calendar-heading", abbr: "Tuesday" }, "Tu"), h("th", { key: '27cb255acfe4bd2455d5a851fdbc23dcc672f4d6', class: "yeti-date-calendar-heading", abbr: "Wednesday" }, "We"), h("th", { key: 'f1674bcc068d3726fa5b6da9754da774f24cff73', class: "yeti-date-calendar-heading", abbr: "Thursday" }, "Th"), h("th", { key: '16cec68601417841b9165e1bc373972fa53e1917', class: "yeti-date-calendar-heading", abbr: "Friday" }, "Fr"), h("th", { key: '9171d3398248a7b6f88a0abdc0a3eab4af074b26', class: "yeti-date-calendar-heading", abbr: "Saturday" }, "Sa"))), this.renderMonthTBody(this.cursorDate)))));
    }
    componentDidRender() {
