...
const YetiDatePicker = class {
    ...
    render() {
        ...
        return (h("div", { key: '0302f713718be7ba19befdd15de37679daf14446', class: "yeti-date" }, (this.showErrorTooltip && this.isValid == false) ?
            h("yeti-tooltip", { text: this.tooltipText, position: "below", forceOpen: true }, this.renderInput(cssClasses))
            :
                this.renderInput(cssClasses), h("button", { key: '73b8710dee5debe754f431cd991cf7822d03baae', class: "yeti-date-button", "aria-label": this.getIconButtonLabel(), onClick: (ev) => { this.handleIconClick(ev); } }, h("span", { key: '24904b5e27d97f899858c83a71852555ef6861f1', class: "material-icons yeti-date-button-icon", "aria-hidden": "true" }, "calendar_today")), h("div", { key: '8a9b05b80dfece116c9ee1b7c224e3c2d03e1b16', class: (this.isPickerVisible) ? "yeti-date-picker yeti-date-picker__visible" : "yeti-date-picker" }, h("div", { key: '36df2486357953aca10091079860a149c9b4d97a', class: "yeti-date-picker-header" }, h("h2", { key: 'c4392c2f5854a28fc654936333f685e5a012526e', class: "yeti-date-picker-heading", "aria-live": "polite", id: this.pickerHeading }, utils.getMonthName(this.cursorDate), " ", this.cursorDate.getFullYear()), h("ul", { key: '3e2c54649a7d2c029ca08f5fc83ebb5547177be4', class: "yeti-date-picker-actions" }, h("li", { key: '63b6e90648b8595753fb9859d0d0ddbae3d782e0', class: "yeti-date-picker-action" }, h("button", { key: 'af6ec2acbb38b2c8a3e4ae49efa53df82edef744', class: "yeti-date-picker-action-button yeti-date-picker-action-button-first", onClick: (ev) => {
                this.cursorDatePreviousYear();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: 'dc3f5016861e652be15a21b526e2e8308f8354e3', class: "yeti-a11y-hidden" }, "Previous year"), h("span", { key: 'd648cd9de48272a3baca7b7b4353f8166855f727', class: "material-icons", "aria-hidden": "true", title: "Previous year" }, "keyboard_double_arrow_left"))), h("li", { key: '44286956bff992fec81a087f70ec51ad7d5327ea', class: "yeti-date-picker-action" }, h("button", { key: '54e0c9030c96f5188a3f2a63162e1be3b9409d42', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDatePreviousMonth();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: '3d6855b0e4675b9d663c8f45bfe37a0d3747f6b6', class: "yeti-a11y-hidden" }, "Previous month"), h("span", { key: '21bc80e4e88626d6cd915b94633c31b834f7824f', class: "material-icons", "aria-hidden": "true", title: "Previous month" }, "keyboard_arrow_left"))), h("li", { key: 'eaffd2ffa90728733fec0010fe12413baa4003d4', class: "yeti-date-picker-action" }, h("button", { key: '776cda988e45f09ec7d116a44896da5579ef374e', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDateNextMonth();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: '8ecc246b7c7ac7c38cf07093204f0a1cf54e62c8', class: "yeti-a11y-hidden" }, "Next month"), h("span", { key: '2941d4895a70ab4062dfdfb3483b80e120446712', class: "material-icons", "aria-hidden": "true", title: "Next month" }, "keyboard_arrow_right"))), h("li", { key: '8abbd1a794a1377e6f8eeacc7bf6865f8377c94f', class: "yeti-date-picker-action" }, h("button", { key: 'ebe5ddb68c3a2bba85a9e9a325e649089f070eb4', class: "yeti-date-picker-action-button", onClick: (ev) => {
                this.cursorDateNextYear();
                ev.preventDefault();
                ev.stopPropagation();
            } }, h("span", { key: 'c77e0c0cfe9a4eaf4c22289c0922bdb67ec22977', class: "yeti-a11y-hidden" }, "Next year"), h("span", { key: 'a2ee0066d8fca2f948e146b83454de827f3c2646', class: "material-icons", "aria-hidden": "true", title: "Next year" }, "keyboard_double_arrow_right"))))), h("table", { key: 'f30177245f93adafdc0f653e83f764aeeddd2085', class: "yeti-date-calendar", role: "grid", "aria-labeledby": this.pickerHeading, onKeyDown: (ev) => { this.handleCalendarKeydown(ev); } }, h("thead", { key: 'e00ee2b60ef8800b658d0395e18d97fa5455c8ae' }, h("tr", { key: 'ef6ff4846a76da8c6342761eab9cb9b218726fbf' }, h("th", { key: '1dee7434f6bc79beeb98c04832c30d81818329cc', class: "yeti-date-calendar-heading", abbr: "Sunday" }, "Su"), h("th", { key: '45a8c8a0bb95946ead84c1cfcbc4cf67c7a3e2e5', class: "yeti-date-calendar-heading", abbr: "Monday" }, "Mo"), h("th", { key: '3c3b42ad7db2c6ff04c86ac21aa949c3a8049a6c', class: "yeti-date-calendar-heading", abbr: "Tuesday" }, "Tu"), h("th", { key: 'e053380d13d867609160118d73060cd483e818db', class: "yeti-date-calendar-heading", abbr: "Wednesday" }, "We"), h("th", { key: '727d57b9d9792742d8d84f8985f0883b605026a7', class: "yeti-date-calendar-heading", abbr: "Thursday" }, "Th"), h("th", { key: 'd228d81666a444f2c357c38e2c01920bbd29405e', class: "yeti-date-calendar-heading", abbr: "Friday" }, "Fr"), h("th", { key: 'c8796e3833f3a36eac7ed87e510760e38312c6f2', class: "yeti-date-calendar-heading", abbr: "Saturday" }, "Sa"))), this.renderMonthTBody(this.cursorDate)))));
    }
    componentDidRender() {
