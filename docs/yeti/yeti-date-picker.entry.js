...
const YetiDatePicker = class {
  ...
  render() {
    ...
    return (h("div", { class: "yeti-date" }, h("input", Object.assign({ type: "text", class: cssClasses, id: this.inputId, name: this.inputName, value: this.value, onBlur: (ev) => this.handleFieldBlur(ev), "aria-invalid": !this.isValid, placeholder: "mm/dd/yyyy" }, ((this.describedBy != "") ? { "aria-describedby": this.describedBy } : {}))), h("button", { class: "yeti-date-button", "aria-label": this.getIconButtonLabel(), onClick: () => { this.handleIconClick(); } }, h("span", { class: "material-icons yeti-date-button-icon", "aria-hidden": "true" }, "calendar_today")), h("div", { class: (this.isPickerVisible) ? "yeti-date-picker yeti-date-picker__visible" : "yeti-date-picker" }, h("div", { class: "yeti-date-picker-header" }, h("h2", { class: "yeti-date-picker-heading", "aria-live": "polite", id: "heading" }, utils.getMonthName(this.cursorDate), " ", this.cursorDate.getFullYear()), h("ul", { class: "yeti-date-picker-actions" }, h("li", { class: "yeti-date-picker-action" }, h("button", { class: "yeti-date-picker-action-button yeti-date-picker-action-button-first", onClick: () => {
      ...
      } }, h("span", { class: "yeti-a11y-hidden" }, "Previous month"), h("span", { class: "material-icons", "aria-hidden": "true", title: "Previous month" }, "keyboard_arrow_left"))), h("li", { class: "yeti-date-picker-action" }, h("button", { class: "yeti-date-picker-action-button", onClick: () => {
        this.cursorDateNextMonth();
      } }, h("span", { class: "yeti-a11y-hidden" }, "Next month"), h("span", { class: "material-icons", "aria-hidden": "true", title: "Next month" }, "keyboard_arrow_right"))), h("li", { class: "yeti-date-picker-action" }, h("button", { class: "yeti-date-picker-action-button", onClick: () => {
        this.cursorDateNextYear();
      } }, h("span", { class: "yeti-a11y-hidden" }, "Next year"), h("span", { class: "material-icons", "aria-hidden": "true", title: "Next year" }, "keyboard_double_arrow_right"))))), h("table", { class: "yeti-date-calendar", role: "grid", "aria-labelledby": "heading", onKeyUp: (ev) => { this.handleCalendarKeydown(ev); } }, h("thead", null, h("tr", null, h("th", { class: "yeti-date-calendar-heading", abbr: "Sunday" }, "Su"), h("th", { class: "yeti-date-calendar-heading", abbr: "Monday" }, "Mo"), h("th", { class: "yeti-date-calendar-heading", abbr: "Tuesday" }, "Tu"), h("th", { class: "yeti-date-calendar-heading", abbr: "Wednesday" }, "We"), h("th", { class: "yeti-date-calendar-heading", abbr: "Thursday" }, "Th"), h("th", { class: "yeti-date-calendar-heading", abbr: "Friday" }, "Fr"), h("th", { class: "yeti-date-calendar-heading", abbr: "Saturday" }, "Sa"))), this.renderMonthTBody(this.cursorDate)))));
  }
