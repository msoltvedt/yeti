...
const YetiCombobox = class {
  ...
  render() {
    ...
    return ([
      h("div", { class: wrapperCss }, h("div", { class: "yeti-combobox", onClick: (ev) => this.handleClick(ev) }, h("input", Object.assign({ type: "text", class: "yeti-combobox-input",
        // title={this.value}
        ...
        :
          "", h("button", { class: "yeti-combobox-button", tabIndex: -1, "aria-controls": this.dropdownId, "aria-expanded": this.isOpen, id: this.buttonId, onClick: (ev) => { this.handleButtonClick(ev); } }, (!this.isLookup) ?
        h("yeti-icon", { iconCode: (this.isOpen ? 'expand_less' : 'expand_more'), alt: (this.isOpen ? 'close' : 'open') })
        :
          h("yeti-icon", { iconCode: 'search', alt: (this.isOpen ? 'lookup, close' : 'lookup, open') }))), h("div", { class: dropdownCss }, h("ul", { class: "yeti-combobox-options", id: this.dropdownId, role: "listbox" }, this.options.map((option, i) => {
