...
const YetiModal = class {
  ...
  render() {
    ...
    return (h("div", { class: modalOverlayCSS }, h("div", { class: "yeti-modal-bumper-front", tabIndex: 0 }), h("div", Object.assign({ class: modalCSS }, modalProperties), h("div", { class: "yeti-modal-header" }, h("h1", { class: "yeti-modal-header-heading", id: this.headingId }, this.heading), h("div", { class: "yeti-modal-header-action" }, h("slot", { name: "header_action" })), (this.showClose) ?
      h("button", { class: "yeti-modal-header-close yeti-button-ghost", onClick: () => { this.isActive = false; } }, h("span", { class: "material-icons" }, "close"))
      :
        null), h("div", { class: "yeti-modal-content" }, h("div", { class: "yeti-modal-content-actual" }, h("slot", { name: "content" })), h("div", { class: "yeti-modal-content-fade" })), h("div", { class: "yeti-modal-actions" }, h("div", { class: "yeti-modal-actions-buttons" }, h("slot", { name: "buttons" })))), h("div", { class: "yeti-modal-bumper-back", tabIndex: 0 })));
  }
  componentDidRender() {
