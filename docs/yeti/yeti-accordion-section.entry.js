...
const YetiAccordionSection = class {
    ...
    render() {
        ...
        return (h("div", { key: '1ad584b12f183af980a177ac5b027a9862ef5f51', class: wrapperCSS }, h("button", Object.assign({ key: '44a15b960ad1c3271eb207ca505f70948c34b191', id: this.headingId, class: "yeti-accordion-section-heading", onClick: (e) => { this.handleSectionClick(e); }, "aria-expanded": `${this.isOpen}`, "aria-controls": this.sectionId }, (!this.isOpenable ? { "disabled": true, "tabIndex": -1 } : {})), h("div", { key: 'ee679d8f0aacf76be241d45626adea3eaf92eb47', class: 'yeti-accordion-section-heading-contents' }, (this.isOpen) ?
            h("yeti-icon", { iconCode: 'expand_less', alt: '', iconClass: 'yeti-accordion-section-heading-caret' })
            :
                h("yeti-icon", { iconCode: 'expand_more', alt: '', iconClass: 'yeti-accordion-section-heading-caret' }), h("div", { key: '1d7a666ee183f5e74baf162a0ccec81c4d45b17d', class: "yeti-accordion-section-heading-actual" }, (this.isNumbered) ? (this.index + 1) : "", " ", this.heading), this.renderStatusIcon())), h("div", { key: '5d5bb201de6fffb3e29971ce66f4d6ef9dad21f5', id: this.sectionId, class: "yeti-accordion-section-content", role: "region", "aria-labelledby": this.headingId }, h("slot", { key: 'de332633b03c5ca40f86ae33c86dbb4723d2cab9', name: "content" })), h("div", { key: 'ed263231b9e10df01463386fb6f22bc715cd73a0', class: "yeti-accordion-section-actions" }, this.renderActions())));
    }
