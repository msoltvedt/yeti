...
const YetiAccordionSection = class {
    ...
    render() {
        ...
        return (h("div", { key: 'b1b8190847128b61dbc10bd5ff7142a36cefebae', class: wrapperCSS }, h("button", Object.assign({ key: 'e1ae3e2bdab56bd0fddf9b145f44592e53bca969', id: this.headingId, class: "yeti-accordion-section-heading", onClick: (e) => { this.handleSectionClick(e); }, "aria-expanded": `${this.isOpen}`, "aria-controls": this.sectionId }, (!this.isOpenable ? { "disabled": true, "tabIndex": -1 } : {})), h("div", { key: '70c03128049a0c329b8669889951cdc2681db346', class: 'yeti-accordion-section-heading-contents' }, (this.isOpen) ?
            h("yeti-icon", { iconCode: 'expand_less', alt: '', iconClass: 'yeti-accordion-section-heading-caret' })
            :
                h("yeti-icon", { iconCode: 'expand_more', alt: '', iconClass: 'yeti-accordion-section-heading-caret' }), h("div", { key: 'a9e6a579dc081025218d3913a14c3a1cad029e4b', class: "yeti-accordion-section-heading-actual" }, (this.isNumbered) ? (this.index + 1) : "", " ", this.heading), this.renderStatusIcon())), h("div", { key: '3a616c0d4ea22cba8264d05920fa8ea03be23263', id: this.sectionId, class: "yeti-accordion-section-content", role: "region", "aria-labelledby": this.headingId }, h("slot", { key: '281551f0214bf3e2a89b50ca2d9ec9c73a25aaac', name: "content" })), h("div", { key: '2f275d5329a028303372d665ede6f0efcc4a0758', class: "yeti-accordion-section-actions" }, this.renderActions())));
    }
