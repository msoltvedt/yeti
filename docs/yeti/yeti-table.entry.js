...
const YetiTable = class {
    ...
    render() {
        ...
        return (h("table", { key: '654f4f6531d0a5be17a37f1310f355ee48dfa34e', class: cssClass }, (this.contents.head) ?
            ...
            :
                "", h("tbody", { key: 'f6fda0554cff4401c993c963fd6b31651bef2b41', class: "yeti-table-body" }, this.renderRows(this.firstRecordIndexToDisplay, this.numRecordsToDisplay))));
    }
    componentDidRender() {
