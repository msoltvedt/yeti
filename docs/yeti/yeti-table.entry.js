...
const YetiTable = class {
    ...
    renderTableHeadingFilter(cell, headingLabelId) {
        ...
        let filterPlaceholderLabel = ((_a = cell.filtering) === null || _a === void 0 ? void 0 : _a.placeholder) ? cell.filtering.placeholder : "-Any-";
        switch (cell.filtering.type) {
            ...
            case "select":
                ...
                return h("select", { class: "yeti-select yeti-table-heading-filter-input", onChange: (ev) => {
                    ...
                    }, "aria-labelledby": headingLabelId }, h("option", { value: "", id: `${filterId}_defaultOption`, key: `${filterId}_defaultOption` }, filterPlaceholderLabel), selectOptions);
            case "date":
            ...
            case "multiselect":
                ...
                return h("yeti-dropdown", { "is-multiselect": "true", placeholder: filterPlaceholderLabel, "data-column": cell.columnIndex, "labelled-by": headingLabelId, id: filterId, key: filterId, value: cell.filtering.value, options: yetiOptions });
            default:
    ...
    render() {
        ...
        return (h("table", { key: '07fc93dc104e69939f4fe38a03a119eb94e1779c', class: cssClass }, (this.contents.head) ?
            ...
            :
                "", h("tbody", { key: '7938639d2d212f8d948ee5b76d48db9b07ab871e', class: "yeti-table-body" }, this.renderRows(this.firstRecordIndexToDisplay, this.numRecordsToDisplay))));
    }
    componentDidRender() {
