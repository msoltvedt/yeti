...
const YetiTable = class {
    ...
    render() {
        ...
        return (h("table", { key: '32ae6e2333a5a4270681e362c27d66a70cec8544', class: cssClass }, (this.contents.head) ?
            ...
            :
                "", h("tbody", { key: '0621abdcb70cdde2daf56940a0bab664c05e3b24', class: "yeti-table-body" }, this.renderRows(this.firstRecordIndexToDisplay, this.numRecordsToDisplay))));
    }
    componentDidRender() {
