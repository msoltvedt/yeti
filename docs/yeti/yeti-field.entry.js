...
const YetiField = class {
  ...
  render() {
    ...
    return (h("div", { class: cssClass }, h("label", { htmlFor: this.inputId, class: "yeti-form-label" }, `${this.label} `, (this.required && this.hasSlottedRequired) ? h("slot", { name: "required" }) : null), (!this.hasSlottedField) ?
      (this.type == "date") ?
