...
const YetiField = class {
    ...
    render() {
        ...
        return (h("div", { key: '3ecf764dd11b134e5ee591d44db8661ff2cf9ae2', class: cssClass }, h("label", { key: '9fb4f8d62de4d6102e23ea0abd0b194b78ca7cc5', htmlFor: this.inputId, class: "yeti-form-label" }, `${this.label} `, (this.required && this.hasSlottedRequired) ? h("slot", { name: "required" }) : null), (!this.hasSlottedField) ?
            (this.type == "date") ?
