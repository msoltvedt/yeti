...
const YetiTooltip = class {
  ...
  render() {
    ...
    return (h("div", { class: wrapperClass, id: this.notificationId, role: "status" }, h("div", { class: "yeti-notification-icon" }, h("span", { class: "material-icons", "aria-hidden": "true" }, iconCode), h("span", { class: "yeti-a11y-hidden" }, altText)), h("div", { class: "yeti-notification-content" }, (this.textTitle != "") ?
      h("div", { class: "yeti-notification-content-title" }, this.textTitle)
      :
        '', h("div", { class: "yeti-notification-content-subtitle" }, h("slot", null))), (this.actionLabel != "") ?
