...
const YetiDropdown = class {
    ...
    render() {
        ...
        return ([
            h("div", { key: '34857774d65d58c69ec939ec63bf158e7cdc20f2', class: "yeti-dropdown-wrapper" }, h("div", Object.assign({ key: 'd29d0e457443dbafa45e71b0fdaa7141730df0da', tabIndex: 0, class: comboboxClasses, onClick: () => {
                    this.isOpen = !this.isOpen;
                }, onFocus: () => {
                    this.isTouched = true;
                }, role: "combobox" }, ((!this.isValid) ? { "aria-invalid": 'true' } : {}), ((this.labelledBy != "") ? { "aria-labeledby": this.labelledBy } : {}), ((this.describedBy != "") ? { "aria-describedby": this.describedBy } : {}), { "aria-controls": this.flyoutId, "aria-expanded": this.isOpen, "aria-haspopup": "listbox" }, ((this.isOpen && this.cursorPosition >= 0) ? { "aria-activedescendant": this.options[this.cursorPosition].id } : {}), { id: this.comboboxId }, ((this.isSearchable) ? { "aria-description": "searchable" } : {})), h("span", { key: 'b1388675353b200f6f0a9dd9741d736fa7e4c9b1', class: "yeti-dropdown-placeholder", title: this.getPlaceholderDisplay() }, this.getPlaceholderDisplay(), (this.numSelections > 1) ?
                ...
                :
                    ""), h("div", { key: '00e98344a983f5dad43ffcfd57b37614a60adf58', class: flyoutClass }, /*Search field */ (this.isSearchable) ?
                ...
                :
                    "", h("ul", Object.assign({ key: '6491530fb948ed27f7cf990587c655a721b71282', class: "yeti-dropdown-options", id: this.flyoutId, role: "listbox", "aria-multiselectable": "true" }, ((this.labelledBy != "") ? { "aria-labeledby": this.labelledBy } : {}), ((this.isOpen && this.cursorPosition >= 0) ? { "aria-activedescendant": this.options[this.cursorPosition].id } : {})), this.options.map((option, i) => {
