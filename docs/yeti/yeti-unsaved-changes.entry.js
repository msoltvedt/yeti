...
const YetiUnsavedChanges = class {
    ...
    render() {
        return (h(Host, { key: '4f81062cea392f1fbd1e029b812dab102ad46bdf' }, h("yeti-modal", { key: 'a80dd1a183864b20092a92b80f0649802cd34cde', heading: "Unsaved Changes", id: "modal1", "described-by": "modal1_description", isActive: this.isOpen, showClose: false }, h("yeti-modal-content", { key: 'c6d729f3bbb9f7fcf11e4bcfa23691df317c1996' }, h("p", { key: '5fb942f06cc5852fdb43b056b99c68fdada3c75b', id: "modal1_description", class: "yeti-margin-bottom-4" }, "You have unsaved changes that will be lost."), h("p", { key: '74b35db38a43234181a67f72bbcbaa9fcc51f648' }, "Are you sure you want to leave the page?")), h("yeti-modal-buttons", { key: '0ed03dcdbf8ecfe0da98c52b816cbfa202d82815' }, h("button", { key: '357b118df33bdfeffdd39c21e61045de6cbf6308', class: "yeti-button yeti-button-primary", id: "unsavedChangesModalPrimaryButton", onClick: () => { this.handleModalPrimaryClick(); } }, "Yes, Discard Changes"), h("button", { key: '35b03636f759292c8f2ac6b001bef27f470ac895', class: "yeti-button yeti-button-secondary", id: "unsavedChangesModalSecondaryButton", onClick: () => { this.handleModalSecondaryClick(); } }, "No, Keep Editing")))));
    }
