import { r as registerInstance, h, e as Host, g as getElement } from './index-2baeb834.js';
...
const YetiUnsavedChanges = class {
    ...
    render() {
        return (h(Host, { key: 'e073017cc965fa313159a1f8c330364d375f79da' }, h("yeti-modal", { key: 'e645187a8192b500e4347970a46f8e6c1377cec1', heading: "Unsaved Changes", id: "modal1", "described-by": "modal1_description", isActive: this.isOpen, showClose: false }, h("yeti-modal-content", { key: '42cd6558725785dd4067c05f11224dca912f482c' }, h("p", { key: 'ada49b7ac913472faecab790864b2ded986fd7c4', id: "modal1_description", class: "yeti-margin-bottom-4" }, "You have unsaved changes that will be lost."), h("p", { key: '925ed09c66834e3ba087acbcf883ce2eaa719218' }, "Are you sure you want to leave the page?")), h("yeti-modal-buttons", { key: 'cfcb3b24d0dc2e4611d7a347c4abcfaf0989a6ab' }, h("button", { key: '761d6d4c86e4559205d4270a37c7e104ed9cf6d4', class: "yeti-button yeti-button-primary", id: "unsavedChangesModalPrimaryButton", onClick: () => { this.handleModalPrimaryClick(); } }, "Yes, Discard Changes"), h("button", { key: '813580410a36c61f0073a2ba4c5ad4a666c3caab', class: "yeti-button yeti-button-secondary", id: "unsavedChangesModalSecondaryButton", onClick: () => { this.handleModalSecondaryClick(); } }, "No, Keep Editing")))));
    }
