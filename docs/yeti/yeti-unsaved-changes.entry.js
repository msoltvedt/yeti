...
const YetiUnsavedChanges = class {
    ...
    render() {
        return (h(Host, { key: '12fb0f9845f16c7d6ab26569bef6c23ef5c1233a' }, h("yeti-modal", { key: 'addbc023b0350e082af1bf66adbd0b65678ca87c', heading: "Unsaved Changes", id: "modal1", "described-by": "modal1_description", isActive: this.isOpen, showClose: false }, h("yeti-modal-content", { key: 'f9711019ffd0fb516f163549d06f79d8559664f0' }, h("p", { key: '0d261c21f2a2a02d8ef28f693424638d728d273e', id: "modal1_description", class: "yeti-margin-bottom-4" }, "You have unsaved changes that will be lost."), h("p", { key: '058c93f987ad485076b009941c91738a8edc4828' }, "Are you sure you want to leave the page?")), h("yeti-modal-buttons", { key: '38e833d7d1c55e149f4a2bcb530d3643af348bbc' }, h("button", { key: '06a41972bbe5a156358f9b7e1c0bfb77a2346d18', class: "yeti-button yeti-button-primary", id: "unsavedChangesModalPrimaryButton", onClick: () => { this.handleModalPrimaryClick(); } }, "Yes, Discard Changes"), h("button", { key: 'd39ef2b4d7521346d7868f476fdce060bd2f48e3', class: "yeti-button yeti-button-secondary", id: "unsavedChangesModalSecondaryButton", onClick: () => { this.handleModalSecondaryClick(); } }, "No, Keep Editing")))));
    }
