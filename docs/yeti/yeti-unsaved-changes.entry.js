...
const YetiUnsavedChanges = class {
    ...
    render() {
        return (h(Host, { key: 'c3d192ad20ac30add4dd83419a959cb92f1a1cc8' }, h("yeti-modal", { key: '3c0652cae34f9e942f21a51a92cf202c92cf5ee3', heading: "Unsaved Changes", id: "modal1", "described-by": "modal1_description", isActive: this.isOpen, showClose: false }, h("yeti-modal-content", { key: 'e28a1a4e63617e2cbe9c0a1c598608808a4cfbcb' }, h("p", { key: '2a2056f3ee2621b7d59ebf6bdf4119a951d71233', id: "modal1_description", class: "yeti-margin-bottom-4" }, "You have unsaved changes that will be lost."), h("p", { key: '79d472c9910688b141217d3c989dfc154dc182a2' }, "Are you sure you want to leave the page?")), h("yeti-modal-buttons", { key: 'b5e3dca0358e7e5b3f2e235390dfd1733f627834' }, h("button", { key: '8000e79e58d44b125e630a3c0b243454bb36e79a', class: "yeti-button yeti-button-primary", id: "unsavedChangesModalPrimaryButton", onClick: () => { this.handleModalPrimaryClick(); } }, "Yes, Discard Changes"), h("button", { key: '0b0aa92b2cfea35dbe42558ceed3c923c7dccb91', class: "yeti-button yeti-button-secondary", id: "unsavedChangesModalSecondaryButton", onClick: () => { this.handleModalSecondaryClick(); } }, "No, Keep Editing")))));
    }
