...
const YetiUnsavedChanges = class {
    ...
    render() {
        return (h(Host, { key: '38c5d0dac9f8546244a8d0a8a3c81745509a85cd' }, h("yeti-modal", { key: '6603e7502a46152ed3a5fdf21c0b156a218d013e', heading: "Unsaved Changes", id: "modal1", "described-by": "modal1_description", isActive: this.isOpen, showClose: false }, h("yeti-modal-content", { key: '85fd48f494e22d40bb469d2aec6e1e3e263e0391' }, h("p", { key: '8a075c9d75fe81c2d54613d7cc60ebb740cc7138', id: "modal1_description", class: "yeti-margin-bottom-4" }, "You have unsaved changes that will be lost."), h("p", { key: '49002b3e47b9f9b5f1614cb4304181f1c738d281' }, "Are you sure you want to leave the page?")), h("yeti-modal-buttons", { key: 'c1f3b413848d895b2267ba241793d243caa1b19f' }, h("button", { key: '115d044ba37ab6f9426f5761b3af39b2634cab1d', class: "yeti-button yeti-button-primary", id: "unsavedChangesModalPrimaryButton", onClick: () => { this.handleModalPrimaryClick(); } }, "Yes, Discard Changes"), h("button", { key: '91534e18ca4047952c2e758548a6dc247184994b', class: "yeti-button yeti-button-secondary", id: "unsavedChangesModalSecondaryButton", onClick: () => { this.handleModalSecondaryClick(); } }, "No, Keep Editing")))));
    }
