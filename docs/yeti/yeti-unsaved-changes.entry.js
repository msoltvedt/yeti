...
const YetiUnsavedChanges = class {
    ...
    render() {
        return (h(Host, { key: '38520e81bb4b98e5d9740133d15557521a48b108' }, h("yeti-modal", { key: '0df5e49f1b832744cc9872591e9cba5551637fee', heading: "Unsaved Changes", id: "modal1", "described-by": "modal1_description", isActive: this.isOpen, showClose: false }, h("yeti-modal-content", { key: '101384a27b00aaf0ebf2e9f477f9cf920afff958' }, h("p", { key: '37ac6871a6f1c34a4bd7d31f5fb809797b787e82', id: "modal1_description", class: "yeti-margin-bottom-4" }, "You have unsaved changes that will be lost."), h("p", { key: '9f0db2e362fcd8bc8320390e204254a87741d6d1' }, "Are you sure you want to leave the page?")), h("yeti-modal-buttons", { key: '9c408896061507923501caa8ebc8ff8a844712c7' }, h("button", { key: 'c7c691a0cad4b68badf9c24163ad58626f4dfbcc', class: "yeti-button yeti-button-primary", id: "unsavedChangesModalPrimaryButton", onClick: () => { this.handleModalPrimaryClick(); } }, "Yes, Discard Changes"), h("button", { key: 'c232bdfd28583ab6bc680abaea48f9d4fc464572', class: "yeti-button yeti-button-secondary", id: "unsavedChangesModalSecondaryButton", onClick: () => { this.handleModalSecondaryClick(); } }, "No, Keep Editing")))));
    }
