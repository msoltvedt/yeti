...
const YetiMultiselect = class {
    ...
    render() {
        ...
        return ([
            h("div", { key: '15f8aa60a4738c8f44baaec526b299d7e654e521', class: "yeti-multiselect-wrapper" }, h("select", Object.assign({ key: 'a46d417fdfefe154dcc124d344ad17d5289bb6cc', tabIndex: -1, class: "yeti-multiselect-actual yeti-a11y-hidden", multiple: true, id: this.actualId, name: this.actualName, onFocus: () => { this.handleActualFocus(); } }, ((!this.isValid) ? { "aria-invalid": true } : {}), ((this.labelledBy != "") ? { "aria-labelledby": this.labelledBy } : {}), ((this.describedBy != "") ? { "aria-describedby": this.describedBy } : {})), this.renderActualOptions()), h("div", { key: '06caf3bd47039aaba123a1d28ce5ac96597904c2', tabIndex: 0, class: cssClasses, onClick: () => {
                    this.isOpen = !this.isOpen;
                }, onFocus: () => {
                    this.isTouched = true;
                }, "aria-hidden": "true" }, h("span", { key: '61bb87544fb9cc861666eea74f1e17a4ff06865d', class: "yeti-multiselect-placeholder", title: this.getPlaceholderDisplay() }, this.getPlaceholderDisplay()), (this.showClear && this.numSelections > 0) ?
                ...
                :
                    ""), h("div", { key: 'a1e347c9796e9687d05fe5b9182250101b6054e0', class: flyoutClass, "aria-hidden": "true" }, h("ul", { key: '0fc34431b5dac292a208af43a1139cba7827c767', class: "yeti-multiselect-options", id: this.facadeId }, this.options.map((option, i) => {
