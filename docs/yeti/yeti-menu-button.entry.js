...
const YetiMenuButton = class {
    ...
    renderMenuItems() {
        ...
        for (let i = 0; i < this.options.length; i++) {
            ...
            // Nope, it's a button.
                ...
                linkOrButtonElement = h("button", { class: "yeti-menu_button-menu-item-button", role: "menuitem", type: "button", tabindex: "-1", "data-option-index": i, onClick: (ev) => { this.handleOptionClick(i, ev); } }, (option.hasHTML) ? h("slot", { name: option.id }) : option.label);
            }
    ...
    renderButton(buttonClass) {
        return h("button", Object.assign({ class: buttonClass, type: "button", "aria-haspopup": "true" }, ((this.isOpen) ? { "aria-expanded": "true" } : {}), { "aria-controls": this.menuId, id: this.buttonId, role: "button", onClick: (ev) => {
    ...
    render() {
        ...
        return ([
            h("div", { key: 'd599ebf475427403c3e9ba7806d1258bde613c51', class: wrapperClass }, (this.hasTooltip) ?
