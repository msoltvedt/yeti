...
const YetiLoading = class {
  ...
  render() {
    ...
    let baseLoading = h("div", { class: "yeti-loading", tabindex: "-1" }, h("div", { class: "yeti-loading-icon" }, h("svg", { class: "yeti-loading-icon-svg", viewBox: "0 0 100 100", "aria-hidden": "true" }, h("circle", { class: "yeti-loading-icon-svg-circle", cx: "50%", cy: "50%", r: "44" }))), h("div", { class: "yeti-loading-label" }, "Loading..."), (this.slottedContent == null && this.slottedContent != "<!---->") ?
      ""
      :
        h("div", { class: "yeti-loading-content" }, h("slot", null)));
    let inlineLoading = h("div", { class: "yeti-loading_inline" }, h("div", { class: "yeti-loading_inline-icon" }, h("svg", { class: "yeti-loading_inline-icon-svg", viewBox: "0 0 100 100" }, h("circle", { class: "yeti-loading_inline-icon-svg-background", cx: "50%", cy: "50%", r: "44" }), h("circle", { class: "yeti-loading_inline-icon-svg-stroke", cx: "50%", cy: "50%", r: "44" }))), h("div", { class: "yeti-loading_inline-label" }, "Loading..."));
