...
const YetiFileExplorer = class {
  ...
  render() {
    ...
    return (h("div", { class: wrapperClass }, h("div", { class: "yeti-file_explorer" }, h("div", { class: "yeti-file_explorer-folders" }, this.renderFolders())), h("div", { class: "yeti-file_explorer-path" }, this.path[this.path.length - 1].displayPath)));
  }
  componentDidRender() {
