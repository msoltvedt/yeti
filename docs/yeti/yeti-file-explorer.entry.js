...
const YetiFileExplorer = class {
    ...
    render() {
        ...
        return (h("div", { key: 'ec0e775c80dcabc8794851dbf18ea52ead4081e6', class: wrapperCSS }, h("div", { key: '8834d4784b08ea9f7f81b1bffb71b2691d25ad3a', class: "yeti-file_explorer" }, h("div", { key: '337f9880b4a9382144f7a199ddad8c558abd7a73', class: "yeti-file_explorer-folders" }, this.renderFolders())), h("div", { key: 'c506a941beaa2c9e8f2985375e7a0b8ad381b163', class: "yeti-file_explorer-path" }, this.path[this.path.length - 1].path)));
    }
    componentDidRender() {
