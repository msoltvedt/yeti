...
| `indicateRequired`  | `indicate-required`   | Whether to indicate the field is required by showing a default icon.                                                           | `boolean` | `false`                               |
| `inputClass`        | `input-class`         | Additional user-supplied CSS classes to apply to the input.                                                                    | `string`  | `""`                                  |
...
| `inputWrapperClass` | `input-wrapper-class` | Additional user-supplied CSS classes to apply to the input's wrapper.                                                          | `string`  | `""`                                  |
...
| `label`             | `label`               | Mandatory value for the label of the field.                                                                                    | `string`  | `""`                                  |
| `placeholder`       | `placeholder`         | name that will be assigned to the actual input element. id will be assigned if one is not provided.                            | `string`  | `""`                                  |
...
```mermaid
graph TD;
  yeti-field --> yeti-required-symbol
