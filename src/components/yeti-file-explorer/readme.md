...
| `path`                | --                      | All the displayed folders in order from root to terminus | `YetiFileSystemItem[]` | `[     {       name: "root",       content: [],       path: "",       displayPath: "",       isFolder: true,       isRoot: true,       isSelected: true,       isLoading: false,       selectedIndex: -1,       offset: 0,       pageSize: 1000,       totalElements: 0,       id: utils.generateUniqueId(),       type: "folder"     }   ]` |
