...
| `path`                | --                      | All the displayed folders in order from root to terminus | `YetiFileSystemItem[]` | `[     {       name: "root",       content: [],       path: "",       isFolder: true,       isRoot: true,       isSelected: true,       selectedIndex: -1,       offset: 0,       pageSize: 1000,       totalElements: 0,       id: utils.generateUniqueId(),       type: "folder"     }   ]` |
| `showFiles`           | `show-files`            | Whether or not to show files (folders are always shown). | `boolean`              | `true`                                                                                                                                                                                                                                                                                        |
| `wrapperClass`        | `wrapper-css`           | CSS classlist applied to the explorer wrapper element.   | `string`               | `''`                                                                                                                                                                                                                                                                                          |
