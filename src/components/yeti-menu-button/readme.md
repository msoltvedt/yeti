...
| --------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------- | --------- | ----------- |
| `buttonCSS`     | `button-class`   | CSS classlist to add to the Menu Button's button element.                                                                       | `string`  | `''`        |
...
| `menuCSS`       | `menu-class`     | CSS classlist to add to the Menu Button's menu element.                                                                         | `string`  | `''`        |
...
| `wrapperCSS`    | `wrapper-class`  | CSS classlist to add to the Menu Button pattern's outer wrapper.                                                                | `string`  | `''`        |
