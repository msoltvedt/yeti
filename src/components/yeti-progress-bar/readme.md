...
| ----------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------ | --------- | ------- |
| `barClass`        | `bar-class`        | CSS classlist to add to the element representing the component's progress bar.                                                 | `string`  | `''`    |
...
| `labelClass`      | `label-class`      | CSS classlist to add to the component's actual label element.                                                                  | `string`  | `''`    |
